...
public class Prism_java {
  ...
  public static Prism4j.Grammar create(@NotNull Prism4j prism4j) {
    ...
    GrammarUtils.insertBeforeToken(
        java,
        "function",
        token("annotation", pattern(compile("(^|[^.])@\\w+"), true, false, "punctuation")));
    ...
    GrammarUtils.insertBeforeToken(
        ...
        token(
            ...
            pattern(
                ...
                false,
                "function",
                grammar("inside", keyword, token("punctuation", pattern(compile("[<>(),.:]")))))));
